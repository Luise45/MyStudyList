...
await page.goto('https://project-c5432009-c36e-4cb8-b23.web.app/');
await expect(
    page.getByText('Plan homework, projects and exams in one calm place. MyStudyList helps you keep every task visible and organized.Your personal study list')).toBeVisible();
}); 
